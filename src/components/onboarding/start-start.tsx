...
import { ChevronRight, Sparkle, Target } from 'lucide-react';
    ...
    <main className="flex min-h-dvh flex-col items-center justify-center bg-zinc-50 px-4 py-10">
      <div className="w-full max-w-md">
        <div className="mb-8 text-center">
          ...
          <p className="mt-2 text-sm text-zinc-500">不懂术语也没关系，10 分钟带你拿到一版能投的简历</p>
        </div>

        <div className="space-y-4">
          <p className="text-center text-lg font-bold text-zinc-900">你有想去的岗位吗？</p>
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1">
                <p className="font-bold text-zinc-900">有，我按岗位做简历</p>
                <p className="mt-0.5 text-sm text-zinc-500">我复制一段 JD，AI 帮我拆，再帮我写一版对着要求的简历</p>
              </div>
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1">
                <p className="font-bold text-zinc-900">还没想好，帮我找方向</p>
                <p className="mt-0.5 text-sm text-zinc-500">我说说我都做过什么，AI 告诉我适合哪些岗位</p>
              </div>
              <ChevronRight className="h-5 w-5 text-zinc-400" />
            </div>
          </button>
